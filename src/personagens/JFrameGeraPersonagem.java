...
public class JFrameGeraPersonagem extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jMenuItem3.setText("Ver combatentes");
    ...
    private void jMenuItem2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem2ActionPerformed
        ...
        jTextDestreza.setText(null);
        jTextInteligencia.setText(null);
        Vestiario.combatente.clear();
        jLabelGravados.setText(String.valueOf(Vestiario.getCombatentes()));
    }//GEN-LAST:event_jMenuItem2ActionPerformed

    private void jMenuItem3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem3ActionPerformed
        // TODO add your handling code here:
        if (Vestiario.combatente.size() >= 0){
            JOptionPane.showMessageDialog(null, "Você deve ter pelo menos um combatente gravado");
        } else {
        JFrameVerCombatentes frame = new JFrameVerCombatentes();
